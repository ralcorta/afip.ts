module.exports = {
  title: 'Afip.ts',
  description: 'SDK para los Web Services de Afip',
  base: '/afip.ts/',

  themeConfig: {
    repo: 'valiulab/afip.ts',
    repoLabel: 'GitHub',
    ...
    nav: [
...

      {
        ...
        items: [
          ...
          },
          {
            ...
            link: 'https://github.com/Vincit/afip.ts/tree/v2/doc',
          },
          {
            text: 'v1.x documentation',
            link: 'https://github.com/Vincit/afip.ts/tree/v1/doc',
          },
        ],
      },
      ...
      {
        text: '⭐ Star',
        link: 'https://github.com/vincit/afip.ts',
      },
    ],
